...
category: Marketing, Identity, Multifactor
author:
  name: Diego Poza
...
design:
  bg_color: "#000000"
  image: https://cdn.auth0.com/blog/mfa-myth-reality/mfa-logo.png
tags:
- MFA
- multifactor
- 2FA
- login
related:
- different-ways-to-implement-multifactor
- announcing-Auth0-Guardian-a-new-way-to-login
- how-fingerprint-auth-gives-you-security
---
...
![MFA Example](https://cdn.auth0.com/blog/mfa-myth-reality/mfa-auth.png)
...
RSA and TOTP are two of the most popular methods for generating secure codes that we have today, but they are not interchangeable—both have their pros and cons.
...
![MFA Options](https://cdn.auth0.com/blog/mfa-myth-reality/mfa-options.png)
...
![MFA Methods](https://cdn.auth0.com/blog/mfa-myth-reality/mfa-methods.png)
...
![Guardian MFA](https://cdn.auth0.com/blog/mfa-myth-reality/guardianpicflow.png)
